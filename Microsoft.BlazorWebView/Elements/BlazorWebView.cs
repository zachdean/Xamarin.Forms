...
#pragma warning restore CA1031 // Do not catch general exception types
        ...
        private Task<InteropHandshakeResult> AttachInteropAsync()
        {
            ...
            _ipc.On("BeginInvokeDotNetFromJS", args =>
            {
                ...
                if (assemblyName == "Microsoft.BlazorWebView")
                {
                    assemblyName = null;
...
#pragma warning restore CA1054 // Uri parameters should not be strings
        ...
        private static Stream SupplyFrameworkFile(string uri)
        {
            return uri switch
            {
                "framework://blazor.desktop.js" => typeof(BlazorWebView<>).Assembly.GetManifestResourceStream("Microsoft.BlazorWebView.blazor.desktop.js"),
