...
{
	public partial class LinearGradientExplorerGallery : ContentPage
    {
        ...
        public LinearGradientExplorerGallery()
        {
            InitializeComponent();
            BindingContext = this;
        ...
        {
            _startPoint = GetPointFromString(e.NewTextValue);
            UpdateBackground();
        }

        void OnEndPointChanged(object sender, TextChangedEventArgs e)
        {
            _endPoint = GetPointFromString(e.NewTextValue);
            UpdateBackground();
        }
        ...
        {
            if (_startPoint == null || _endPoint == null || _gradientStops == null)
                return;
