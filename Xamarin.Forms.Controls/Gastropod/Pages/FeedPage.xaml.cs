...
using System.Linq;
using Xamarin.Forms.Controls.Gastropod.Helpers;
...
namespace Xamarin.Forms.Controls.Gastropod
{
    ...
    {
        public ObservableCollection<Seashell> Items { get; set; } = SeashellsHelper.Seashells;
    ...
    public class FeedSearchHandler : SearchHandler
    {
        ...
        protected override void OnQueryChanged(string oldValue, string newValue)
        {
            ...
            else
            {
                ...
                results = SeashellsHelper.Seashells.Where(x => x.Text.IndexOf(newValue, StringComparison.InvariantCultureIgnoreCase) > -1).Select(x => x.Text).ToList<string>();
                ItemsSource = results;
            }
        }
    }
