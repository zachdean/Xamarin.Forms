...
namespace Xamarin.Forms.Platform.iOS
{
	public class PhoneMasterDetailRenderer : UIViewController, IVisualElementRenderer, IEffectControlProvider
	{
		...
		void UpdateMasterDetailContainers()
		{
			...
			if (masterRenderer is AccessiblePageRenderer) // AccessiblePageRenderer's NativeView is the PageContainer, but we need the parent View.
			...
			if (detailRenderer is AccessiblePageRenderer) // AccessiblePageRenderer's NativeView is the PageContainer, but we need the parent View.
