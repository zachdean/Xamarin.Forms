...
namespace Xamarin.Platform
{
	...
	{
		public static void UpdateSearchCommand(this SearchView searchView, ISearch search)
		{

		}

		public static void UpdateSearchCommandParameter(this SearchView searchView, ISearch search)
		{
