...
namespace Xamarin.Platform
{
    public static class GeometryHelper
    {
        ...
        public static void FlattenGeometry(PathGeometry pathGeoDst, Geometry geoSrc, double tolerance, Matrix matxPrevious)
        {
            ...
            {
                foreach (Geometry geoChild in geometryGroup.Children)
                {
            ...
            else if (geoSrc is LineGeometry)
            {
                ...
                if (geoSrc is LineGeometry lineGeoSrc)
                {
            ...
            else if (geoSrc is RectangleGeometry)
            {
                ...
                if (geoSrc is RectangleGeometry rectGeoSrc)
                {
            ...
            else if (geoSrc is EllipseGeometry)
            {
                ...
                if (geoSrc is EllipseGeometry elipGeoSrc)
                {
            ...
            else if (geoSrc is PathGeometry)
            {
                ...
                pathGeoDst.FillRule = pathGeoSrc != null ? pathGeoSrc.FillRule : FillRule.EvenOdd;
                ...
                if (pathGeoSrc != null)
                    foreach (PathFigure figSrc in pathGeoSrc.Figures)
                    {
                        ...
                        foreach (PathSegment segSrc in figSrc.Segments)
                        {
                            ...
                            {
                                if (segSrc is LineSegment lineSegSrc)
                                {
                            ...
                            {
                                if (segSrc is PolyLineSegment polySegSrc)
                            ...
                            {
                                if (segSrc is BezierSegment bezSeg)
                                {
                                    Point pt0 = ptLast;
                            ...
                            {
                                if (segSrc is PolyBezierSegment polyBezSeg)
                            ...
                            {
                                if (segSrc is QuadraticBezierSegment quadBezSeg)
                                {
                                    Point pt0 = ptLast;
                            ...
                            {
                                if (segSrc is PolyQuadraticBezierSegment polyQuadBezSeg)
                            ...
                            else if (segSrc is ArcSegment)
                            {
                                ...
                                if (segSrc is ArcSegment arcSeg)
                                    FlattenArc(
                                        Points,
                                        ptLast,
                                        arcSeg.Point,
