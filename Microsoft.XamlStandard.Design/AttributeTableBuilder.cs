...
namespace Microsoft.XamlStandard.Design
{
	...
	internal class AttributeTableBuilder : Windows.Design.Metadata.AttributeTableBuilder
	{
		public AttributeTableBuilder()
		{
			...
			var fontElements = typeof(Microsoft.XamlStandard.BoxView).Assembly.ExportedTypes.Where(t => typeof(IFontElement).IsAssignableFrom(t));
