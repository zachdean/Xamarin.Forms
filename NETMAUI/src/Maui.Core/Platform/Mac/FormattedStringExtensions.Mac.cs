...
#pragma warning restore 0618
			...
			return new NSAttributedString(span.Text, font == Font.Default ? null : font.ToNSFont(), fgcolor.ToNative(),
				span.BackgroundColor.ToNative(), kerningAdjustment: (float)span.CharacterSpacing);
		}
