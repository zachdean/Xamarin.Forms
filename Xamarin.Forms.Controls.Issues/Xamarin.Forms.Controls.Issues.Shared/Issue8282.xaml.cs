...
namespace Xamarin.Forms.Controls.Issues
{
	...
	[Issue(IssueTracker.Github, 8282, "[Bug] RefreshView draws behind CollectionView Header", PlatformAffected.iOS)]
	...
	[Preserve(AllMembers = true)]
	public class Issue8282ViewModel : BindableObject
	{
		...
		public ObservableCollection<Issue8282Model> Animals { get; private set; } = new ObservableCollection<Issue8282Model>();
		...
		void GetNextPageOfData()
		{
			...
			Debug.WriteLine("Count: " + _itemCount);
		}
		...
		void AddBears()
		{
			Animals.Add(new Issue8282Model
			{
